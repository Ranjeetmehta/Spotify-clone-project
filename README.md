...
```bash
git clone https://ranjeetmehta.github.io/Spotify-clone-project/
cd spotify-clone
```
...
If you have any questions or want to connect, you can reach me at -ranjeetkumarmehta14418@gmail.com.
